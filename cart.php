...
<div class="main">
    <div class="content">
        <div class="cartoption">		
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="padding-top: 30px">
                                        <form action="" method="post">
                                            ...
                                            <input style='border-radius:5px;' class="btn btn-sm btn-primary" type="submit" name="submit" value="Update"/>
                                        </form>
                                    </td>
            ...
            <div class="shopping">
                <div class="shopleft">
                    <a href="index.php"><img style='width:200px;' src="images/shop.png" alt=""/></a>
                </div>
                <div class="shopright">
                    <a href="payment.php"><img style=' width:200px;' src="images/check.png" alt=""/></a>
                </div>
            </div>
        </div>  	
        <div class="clear"></div>
