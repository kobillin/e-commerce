                    ...
                    <tbody class=""> 
                            ...
                            if($getOrder){
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="padding-top: 30px"><?php echo 'Ksh '.$result['price'];?></td>
                                    <td style="padding-top: 30px"><?php echo $fm->formatDate($result['date']);?></td>
                                    <td style="padding-top: 30px"><?php 
                                    if($result['status']==0){
                                        echo '<p class="badge badge-warning">Processing..</p>';
                                    }elseif($result['status']==1){
                                         echo  '<p class="badge badge-primary">Delivered</p>';
                                    }else{
                                        echo '<p class="badge badge-success">Picked</p>';
                                    }?>
                                    </td>
                                    <?php if($result['status']==1){?>
                                    <td style="padding-top: 30px"> <a href="?confirmId=<?php echo $result['orderId'];?>">Confirm?</a></td>
                                    <?php }elseif($result['status']==2){?>
                                    <td style="padding-top: 30px; color:green;">Received</td>
