        ...
        <div class="block" id="section-menu">
            <ul class="section menu">
               <!-- <li><a class="menuitem">Site Option</a>
                ...
                <li><a class="menuitem">Category  <span><img src="img/down.png"></img>  </span></a>
                    <ul class="submenu">
                        <li><a href="catadd.php">Add Category</a> </li>
                        <li><a href="catlist.php">Category List</a> </li>
                    </ul>
                </li>
                <li><a class="menuitem">Brand  <span><img src="img/down.png"></img>  </span></a>
                    <ul class="submenu">
                        <li><a href="brandadd.php">Add Brand</a> </li>
                        <li><a href="brandlist.php">Brand List</a> </li>
                    </ul>
                </li>
                <li><a class="menuitem">Product <span><img src="img/down.png"></img>  </span></a>
                    <ul class="submenu">
