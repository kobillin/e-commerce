    ...
    <div class="row">
        <div class="col-md-4" style="border-right: 2px solid black">
            ...
            <form action="" method="post">  
                ...
                <button style='border-radius:5px;' type="submit" class="btn btn-dark" name="login">Sign In</button>
        ...
        <div class="col-md-8" style="">
            ...
            <form action="" method="post">
                ...
                <button style='border-radius:5px;' type="submit" class="btn btn-dark" name="register">Create Account</button>
            </form>
